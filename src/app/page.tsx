        ...
        <section className="overflow-hidden rounded-[2rem] border bg-card/70 p-8 shadow-xl shadow-black/5 backdrop-blur-sm sm:p-10">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-base leading-7 text-muted-foreground sm:text-lg">
              ...
              text, and design workflows. Each tool lives on its own route, and
              the shared platform stays clean under <code>src/</code>.
            </p>
          </div>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-3">
            <StatCard label="Live tools" value={tools.length.toString()} />
            <StatCard label="Runs locally" value="Client-first" />
            <StatCard label="Shared registry" value="tools.ts" />
          </div>
        </section>
        ...
        <section className="mt-8">
          <div className="mb-4 flex items-center justify-between gap-3">
            <div>
              ...
              <h2 className="mt-1 text-2xl font-semibold">Available tools</h2>
            </div>
            <Badge variant="secondary" className="px-3 py-1">
              Scalable route-based structure
            </Badge>
          </div>
