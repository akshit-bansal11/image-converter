...
export function CategoryCard({
  ...
  return (
    <section className="mb-5 break-inside-avoid">
      <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-[#141414]/95 shadow-[0_0_0_1px_rgba(255,255,255,0.02)]">
        <div className="border-b border-white/8 bg-[linear-gradient(180deg,rgba(44,44,44,0.92)_0%,rgba(31,31,31,0.92)_100%)] p-2">
          <div className="relative rounded-[1.4rem] border border-white/8 bg-white/[0.02] px-6 py-6 sm:px-7 sm:py-7">
            <div className="absolute right-5 top-5 rounded-2xl border border-white/8 bg-white/[0.03] p-3 text-white/35">
            ...
            <div className="relative z-10 max-w-[78%] space-y-3">
              ...
              <p className="max-w-md text-sm leading-6 text-white/45">
                Static utility set with direct routes and focused workflows.
              </p>
            </div>
          </div>
        </div>

        <div className="bg-[linear-gradient(180deg,rgba(18,18,18,0.96)_0%,rgba(12,12,12,0.96)_100%)] px-6 py-6 sm:px-7 sm:py-7">
